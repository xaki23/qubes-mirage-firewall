...
module Client (R: Mirage_random.S) (Time: Mirage_time.S) (Clock : Mirage_clock.MCLOCK) (C: Mirage_console.S) (NET: Mirage_net.S) (DB : Qubes.S.DB) = struct
  ...
  let start _random _time _clock _c network db =
    ...
    Alcotest.run "name" [ general_tests ] >>= fun () ->
